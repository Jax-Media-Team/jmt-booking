...
export const MEETINGS: Record<string, MeetingType> = {
  ...
  'connect': {
    ...
    notificationRecipients: ['pcruz@jaxmediateam.com', 'michael@jaxmediateam.com', 'alan.smodic@jaxmediateam.com', 'john.darabos@jaxmediateam.com'],
  ...
  'seo-team': {
    ...
    notificationRecipients: ['pcruz@jaxmediateam.com', 'alan.smodic@jaxmediateam.com'],
    formFields: [NAME_FIELD, EMAIL_FIELD, COMPANY_FIELD, NOTES_FIELD_DISCOVERY],
  },
  ...
  'discovery': {
    ...
    formFields: [
      ...
      },
      {
        ...
        required: true,
        maxLength: 200,
        helperText: 'This helps us understand the return on our own marketing efforts.',
